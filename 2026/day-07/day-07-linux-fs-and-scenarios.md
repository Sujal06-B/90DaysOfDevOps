Day 07 – Linux File System Hierarchy & Scenario-Based Practice Task
...
- There are following important directories in the linux file system Hierarchy :

Core Directories (Must Know):
/ (root) -
- The starting point of everything.
- This is the root of all files 
- 
/home - User home directories
/root - Root user's home directory
/etc - Configuration files8
9
10
11
12
...
A markdown file named: day-07-linux-fs-and-scenarios.md
or
